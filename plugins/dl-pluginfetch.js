...
cmd({
  ...
  try {
    ...
    _0x82e9b2("🎨 *\`WATSON-XD-BOT RANDOM COLOUR:\`* \n\nColour Name: " + _0x5d0cef + "\nCode: " + _0x256030);
  } catch (_0x563257) {
...
cmd({
  ...
  try {
    ...
    _0x20adfd(" *\`WATSON-XD-BOT Binary Representation:\`* \n\n" + _0x63c851);
  } catch (_0x307dbc) {
...
cmd({
  ...
  try {
    ...
    _0x1fc9a9("*\`WATSON-XD-BOT Decoded Text:\`* \n\n" + _0x26dbbd);
  } catch (_0xbe47d3) {
...
cmd({
  ...
  try {
    ...
    _0xe552ef("*\`WATSON-XD-BOT Decoded Text:\`* \n\n" + _0x529359);
  } catch (_0x28b6de) {
