// Add Member Command Script for WATSON-XD-BOT
// This script allows group admins to add members using the command format: add 263781330745
...
let handler = async (m, { conn, args }) => {
  try {
    ...
    m.reply(`Watson-Xd-Bot : Successfully added @${target.split('@')[0]}`, null, { mentions: [target] });
