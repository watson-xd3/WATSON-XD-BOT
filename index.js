const {
  ...
  const ownerNumber = ['263789622747']
...
const sessdata = config.SESSION_ID.replace("WATSON-XD-BOT~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there WATSON-XD-BOT User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet WATSON-XD-BOT WhatsApp Bot.\n\n *Thanks for using WATSON-XD-BOT \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb2bsRhLCoWthwxUC82B\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/watson-xd3/WATSON-XD-BOT\n\n> © Powered BY WATSON-FOURPENCE \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.imgur.com/QxeVvOc.jpeg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('263789622747', '263781330745', '263789622747');
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("WATSON-XD-BOT STARTED ✅");
  });
